...
{
    public class VisitaGrupalProViewModel : BaseViewModel
    {
        ...
        #region constructors
        public VisitaGrupalProViewModel()
        {
            this.IsEnabled = true;
        }
        #endregion
        ...
        private async void Guardar()//guardar cambios
        {
            ...
            */
            await Application.Current.MainPage.DisplayAlert("Guardado", "Grupo Seleccionado: " + GrupoSelected, "Excelente");
             /*   GrupoSelected = string.Empty;
                ParticipantesVisitaGrupal = string.Empty;
                EquipoFloraPresente = string.Empty;
                OtrosParticipantes = string.Empty;
                TemaObjetivo = string.Empty;
                DesarrolloAcciones = string.Empty;
                MaterialEntregado = string.Empty;
                ProblemasDetectados = string.Empty;
